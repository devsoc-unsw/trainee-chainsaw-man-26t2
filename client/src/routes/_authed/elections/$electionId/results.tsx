    ...
    roles: [
      {
        ...
        title: "Co-President",
        winners: [
          { candidate_id: "3", first_name: "Makima", last_name: "Nakamura" },
        ],
        rounds: [
          {
            candidate_totals: [
      ...
      },
      {
        ...
        title: "Secretary",
        winners: [
          { candidate_id: "5", first_name: "Power", last_name: "Hayakawa" },
        ],
        rounds: [
          {
            candidate_totals: [
  ...
  return (
    <div className="w-full space-y-3">
      <header className="flex items-baseline gap-4">
        ...
        {page && (
          <p className="text-lg font-semibold text-on-dark">{page.title}</p>
        )}
      </header>
